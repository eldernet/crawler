...
When a site is very large you may want to store that queue elsewhere, for example in a database. You can write your own crawl queue by implementing the `Eldernet\Crawler\CrawlQueues\CrawlQueue` interface:
...
- [ArrayCrawlQueue](https://github.com/eldernet/crawler/blob/main/src/CrawlQueues/ArrayCrawlQueue.php) (built in, in memory)
